...
public class VoteApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function votes_get (accessToken: String, clientId: String, userId: Number, causeId: Number, effectId: Number, value: Number, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
     ...
     */
    public function votes_post (accessToken: String, body: Vote): String {
        // create path and map variables
        var path: String = "/votes".replace(/{format}/g,"xml");
        ...
        token.returnType = InlineResponse20036;
        return requestId;
     ...
     * Returns InlineResponse20036 
     */
    public function votes_id_get (id: Number, accessToken: String): String {
        // create path and map variables
     ...
     */
    public function votes_id_put (id: Number, accessToken: String, body: Vote): String {
        // create path and map variables
        var path: String = "/votes/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function votes_id_delete (id: Number, accessToken: String): String {
        // create path and map variables
        var path: String = "/votes/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
