...
public class VariableCategoryApi extends SwaggerApi {
    ...
    */
    ...
    public function variable_categories_get (accessToken: String, name: String, fillingValue: Number, maximumAllowedValue: Number, minimumAllowedValue: Number, durationOfAction: Number, onsetDelay: Number, combinationOperation: String, updated: Number, causeOnly: Boolean, public: Number, outcome: Boolean, createdAt: String, updatedAt: String, imageUrl: String, defaultUnitId: Number, limit: Number, offset: Number, sort: String): String {
        ...
        token.returnType = InlineResponse20031;
        return requestId;
     ...
     */
    public function variable_categories_post (accessToken: String, body: VariableCategory): String {
        // create path and map variables
        var path: String = "/variableCategories".replace(/{format}/g,"xml");
        ...
        token.returnType = InlineResponse20032;
        return requestId;
     ...
     * Returns InlineResponse20032 
     */
    public function variable_categories_id_get (id: Number, accessToken: String): String {
        // create path and map variables
     ...
     */
    public function variable_categories_id_put (id: Number, accessToken: String, body: VariableCategory): String {
        // create path and map variables
        var path: String = "/variableCategories/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function variable_categories_id_delete (id: Number, accessToken: String): String {
        // create path and map variables
        var path: String = "/variableCategories/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
