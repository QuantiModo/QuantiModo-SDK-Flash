...
public class UnitApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function units_get (clientId: String, name: String, abbreviatedName: String, categoryId: Boolean, minimumValue: Number, maximumValue: Number, updated: Number, multiply: Number, add_: Number, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        ...
        token.returnType = InlineResponse20017;
        return requestId;
     ...
     */
    public function units_post (body: Unit): String {
        // create path and map variables
        var path: String = "/units".replace(/{format}/g,"xml");
        ...
        token.returnType = InlineResponse20018;
        return requestId;
     ...
     * Returns InlineResponse20018 
     */
    public function units_id_get (id: Number): String {
        // create path and map variables
     ...
     */
    public function units_id_put (id: Number, body: Unit): String {
        // create path and map variables
        var path: String = "/units/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function units_id_delete (id: Number): String {
        // create path and map variables
        var path: String = "/units/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
