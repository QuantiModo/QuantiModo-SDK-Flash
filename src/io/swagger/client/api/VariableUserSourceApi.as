...
public class VariableUserSourceApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function variable_user_sources_get (accessToken: String, variableId: Number, userId: Number, timestamp: Number, earliestMeasurementTime: Number, latestMeasurementTime: Number, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
     ...
     */
    public function variable_user_sources_post (accessToken: String, body: VariableUserSource): String {
        // create path and map variables
        var path: String = "/variableUserSources".replace(/{format}/g,"xml");
        ...
        token.returnType = InlineResponse20033;
        return requestId;
     ...
     * Returns InlineResponse20033 
     */
    public function variable_user_sources_id_get (id: Number, sourceId: Number, accessToken: String): String {
        // create path and map variables
     ...
     */
    public function variable_user_sources_id_put (id: Number, sourceId: Number, accessToken: String, body: VariableUserSource): String {
        // create path and map variables
        var path: String = "/variableUserSources/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function variable_user_sources_id_delete (id: Number, sourceId: Number, accessToken: String): String {
        // create path and map variables
        var path: String = "/variableUserSources/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
