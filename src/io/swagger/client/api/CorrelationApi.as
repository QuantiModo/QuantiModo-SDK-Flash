...
public class CorrelationApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function correlations_post (accessToken: String, body: Correlation): String {
        // create path and map variables
        var path: String = "/correlations".replace(/{format}/g,"xml");
     ...
     * Returns InlineResponse20018 
     */
    public function correlations_id_get (id: Number, accessToken: String): String {
        // create path and map variables
     ...
     */
    public function correlations_id_put (id: Number, accessToken: String, body: Correlation): String {
        // create path and map variables
        var path: String = "/correlations/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function correlations_id_delete (id: Number, accessToken: String): String {
        // create path and map variables
        var path: String = "/correlations/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
