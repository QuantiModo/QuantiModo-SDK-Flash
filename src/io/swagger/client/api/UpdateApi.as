...
public class UpdateApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function updates_get (accessToken: String, userId: Number, connectorId: Number, numberOfMeasurements: Number, success: Boolean, message: String, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
     ...
     */
    public function updates_post (accessToken: String, body: Update): String {
        // create path and map variables
        var path: String = "/updates".replace(/{format}/g,"xml");
        ...
        token.returnType = InlineResponse20028;
        return requestId;
     ...
     * Returns InlineResponse20028 
     */
    public function updates_id_get (id: Number, accessToken: String): String {
        // create path and map variables
     ...
     */
    public function updates_id_put (id: Number, accessToken: String, body: Update): String {
        // create path and map variables
        var path: String = "/updates/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function updates_id_delete (id: Number, accessToken: String): String {
        // create path and map variables
        var path: String = "/updates/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
