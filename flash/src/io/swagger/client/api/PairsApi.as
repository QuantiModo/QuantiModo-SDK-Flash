...
public class PairsApi extends SwaggerApi {
    ...
    */
    public function PairsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_v1_pairs_csv_get: String = "v1_pairs_csv_get";
     ...
     * Returns Array 
     */
    public function v1_pairs_csv_get (cause: String, effect: String, accessToken: String, causeSource: String, causeUnit: String, delay: String, duration: String, effectSource: String, effectUnit: String, endTime: String, startTime: String, limit: Number, offset: Number, sort: Number): String {
        // create path and map variables
        var path: String = "/v1/pairsCsv".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.completionEventType = "v1_pairs_csv_get";
     ...
     * Returns Array 
     */
    public function v1_pairs_get (cause: String, effect: String, accessToken: String, causeSource: String, causeUnit: String, delay: String, duration: String, effectSource: String, effectUnit: String, endTime: String, startTime: String, limit: Number, offset: Number, sort: Number): String {
        // create path and map variables
