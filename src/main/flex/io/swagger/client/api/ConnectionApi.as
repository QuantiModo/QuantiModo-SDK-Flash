...
public class ConnectionApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function connections_get (userId: Number, connectorId: Number, connectStatus: String, connectError: String, updateRequestedAt: String, updateStatus: String, updateError: String, lastSuccessfulUpdatedAt: String, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
     ...
     */
    public function connections_post (body: Connection): String {
        // create path and map variables
        var path: String = "/connections".replace(/{format}/g,"xml");
     ...
     * Returns InlineResponse2004 
     */
    public function connections_id_get (id: Number): String {
        // create path and map variables
     ...
     */
    public function connections_id_put (id: Number, body: Connection): String {
        // create path and map variables
        var path: String = "/connections/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function connections_id_delete (id: Number): String {
        // create path and map variables
        var path: String = "/connections/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
