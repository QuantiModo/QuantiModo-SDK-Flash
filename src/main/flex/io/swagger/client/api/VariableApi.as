...
public class VariableApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function variables_post (body: Variable): String {
        // create path and map variables
        var path: String = "/variables".replace(/{format}/g,"xml");
     ...
     * Returns InlineResponse20028 
     */
    public function variables_id_get (id: Number): String {
        // create path and map variables
     ...
     */
    public function variables_id_put (id: Number, body: Variable): String {
        // create path and map variables
        var path: String = "/variables/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function variables_id_delete (id: Number): String {
        // create path and map variables
        var path: String = "/variables/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
