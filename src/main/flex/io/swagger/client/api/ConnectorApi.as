...
public class ConnectorApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function connectors_get (name: String, displayName: String, image: String, getItUrl: String, shortDescription: String, longDescription: String, enabled: Boolean, oauth: Boolean, limit: Number, offset: Number, sort: String): String {
     ...
     */
    public function connectors_post (body: Connector): String {
        // create path and map variables
        var path: String = "/connectors".replace(/{format}/g,"xml");
     ...
     * Returns InlineResponse2006 
     */
    public function connectors_id_get (id: Number): String {
        // create path and map variables
     ...
     */
    public function connectors_id_put (id: Number, body: Connector): String {
        // create path and map variables
        var path: String = "/connectors/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function connectors_id_delete (id: Number): String {
        // create path and map variables
        var path: String = "/connectors/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
