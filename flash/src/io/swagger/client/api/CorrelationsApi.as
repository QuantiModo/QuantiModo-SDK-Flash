...
public class CorrelationsApi extends SwaggerApi {
    ...
    */
    public function CorrelationsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_v1_aggregated_correlations_get: String = "v1_aggregated_correlations_get";
        public static const event_v1_aggregated_correlations_post: String = "v1_aggregated_correlations_post";
     ...
     * Returns Array 
     */
    public function v1_aggregated_correlations_get (accessToken: String, effect: String, cause: String, correlationCoefficient: String, onsetDelay: String, durationOfAction: String, lastUpdated: String, limit: Number, offset: Number, sort: Number): String {
        // create path and map variables
        var path: String = "/v1/aggregatedCorrelations".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.completionEventType = "v1_aggregated_correlations_get";
     ...
     * Returns void 
     */
    public function v1_aggregated_correlations_post (body: PostCorrelation, accessToken: String): String {
        // create path and map variables
        var path: String = "/v1/aggregatedCorrelations".replace(/{format}/g,"xml");
        ...
        token.requestId = requestId;
        token.completionEventType = "v1_aggregated_correlations_post";
     ...
     * Returns Array 
     */
    public function v1_correlations_get (accessToken: String, effect: String, cause: String, correlationCoefficient: String, onsetDelay: String, durationOfAction: String, lastUpdated: String, limit: Number, offset: Number, sort: Number): String {
        // create path and map variables
...
if("null" != String(sort))
     ...
     * Returns Array 
     */
    public function v1_organizations_organization_id_users_user_id_variables_variable_name_causes_get (organizationId: Number, userId: Number, variableName: String, organizationToken: String, accessToken: String, includePublic: String): String {
        // create path and map variables
...
if("null" != String(includePublic))
     ...
     * Returns Array 
     */
    public function v1_organizations_organization_id_users_user_id_variables_variable_name_effects_get (organizationId: Number, userId: Number, variableName: String, organizationToken: String, accessToken: String, includePublic: String): String {
        // create path and map variables
...
if("null" != String(includePublic))
     ...
     * Returns Array 
     */
    public function v1_public_correlations_search_search_get (search: String, effectOrCause: String, accessToken: String): String {
        // create path and map variables
...
if("null" != String(effectOrCause))
     ...
     * Returns Array 
     */
    public function v1_variables_variable_name_effects_get (variableName: String, accessToken: String): String {
        // create path and map variables
     ...
     * Returns Array 
     */
    public function v1_variables_variable_name_public_causes_get (variableName: String, accessToken: String): String {
        // create path and map variables
     ...
     * Returns Array 
     */
    public function v1_variables_variable_name_public_effects_get (variableName: String, accessToken: String): String {
        // create path and map variables
