...
public class AggregatedCorrelationApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function aggregated_correlations_post (body: AggregatedCorrelation): String {
        // create path and map variables
        var path: String = "/aggregatedCorrelations".replace(/{format}/g,"xml");
     ...
     * Returns InlineResponse2001 
     */
    public function aggregated_correlations_id_get (id: Number): String {
        // create path and map variables
     ...
     */
    public function aggregated_correlations_id_put (id: Number, body: AggregatedCorrelation): String {
        // create path and map variables
        var path: String = "/aggregatedCorrelations/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function aggregated_correlations_id_delete (id: Number): String {
        // create path and map variables
        var path: String = "/aggregatedCorrelations/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
