...
public class ApplicationEndpointsApi extends SwaggerApi {
    ...
    */
    public function ApplicationEndpointsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_v2_application_connections_get: String = "v2_application_connections_get";
        public static const event_v2_application_credentials_get: String = "v2_application_credentials_get";
        public static const event_v2_application_measurements_get: String = "v2_application_measurements_get";
        public static const event_v2_application_tracking_reminders_get: String = "v2_application_tracking_reminders_get";
        public static const event_v2_application_updates_get: String = "v2_application_updates_get";
        public static const event_v2_application_user_variable_relationships_get: String = "v2_application_user_variable_relationships_get";
        public static const event_v2_application_user_variables_get: String = "v2_application_user_variables_get";
        public static const event_v2_application_variable_user_sources_get: String = "v2_application_variable_user_sources_get";
        public static const event_v2_application_votes_get: String = "v2_application_votes_get";


    /*
     * Returns InlineResponse2003 
     */
    public function v2_application_connections_get (accessToken: String, connectorId: Number, connectStatus: String, connectError: String, updateRequestedAt: String, updateStatus: String, updateError: String, lastSuccessfulUpdatedAt: String, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        // create path and map variables
        var path: String = "/v2/application/connections".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.completionEventType = "v2_application_connections_get";
     ...
     */
    public function v2_application_credentials_get (accessToken: String, connectorId: Number, attrKey: String, attrValue: String, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        // create path and map variables
        var path: String = "/v2/application/credentials".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_credentials_get";
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_measurements_get";
     ...
     */
    public function v2_application_tracking_reminders_get (accessToken: String, clientId: String, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        // create path and map variables
        var path: String = "/v2/application/trackingReminders".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_tracking_reminders_get";
     ...
     */
    public function v2_application_updates_get (accessToken: String, connectorId: Number, numberOfMeasurements: Number, success: Boolean, message: String, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        // create path and map variables
        var path: String = "/v2/application/updates".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_updates_get";
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_user_variable_relationships_get";
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_user_variables_get";
     ...
     */
    public function v2_application_variable_user_sources_get (accessToken: String, variableId: Number, timestamp: Number, earliestMeasurementTime: Number, latestMeasurementTime: Number, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        // create path and map variables
        var path: String = "/v2/application/variableUserSources".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_variable_user_sources_get";
     ...
     */
    public function v2_application_votes_get (accessToken: String, clientId: String, causeId: Number, effectId: Number, value: Number, createdAt: String, updatedAt: String, limit: Number, offset: Number, sort: String): String {
        // create path and map variables
        var path: String = "/v2/application/votes".replace(/{format}/g,"xml");
...
if("null" != String(sort))
        ...
        token.requestId = requestId;
        token.completionEventType = "v2_application_votes_get";
