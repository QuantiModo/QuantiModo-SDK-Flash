...
public class ConnectorsApi extends SwaggerApi {
    ...
    */
    public function ConnectorsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_v1_connect_js_get: String = "v1_connect_js_get";
     ...
     * Returns void 
     */
    public function v1_connect_js_get (accessToken: String): String {
        ...
        token.completionEventType = "v1_connect_js_get";
     ...
     * Returns void 
     */
    public function v1_connect_mobile_get (accessToken: String): String {
        // create path and map variables
     ...
     * Returns void 
     */
    public function v1_connectors_connector_connect_get (connector: String, accessToken: String): String {
        // create path and map variables
     ...
     * Returns void 
     */
    public function v1_connectors_connector_connect_instructions_get (connector: String, parameters: String, url: String, usePopup: Boolean, accessToken: String): String {
        // create path and map variables
...
if("null" != String(usePopup))
     ...
     */
    public function v1_connectors_connector_connect_parameter_get (connector: String, displayName: String, key: String, placeholder: String, type: String, usePopup: Boolean, accessToken: String, defaultValue: String): String {
        // create path and map variables
...
if("null" != String(usePopup))
     ...
     */
    public function v1_connectors_connector_info_get (connector: String, accessToken: String): String {
        // create path and map variables
     ...
     * Returns void 
     */
    public function v1_connectors_connector_update_get (connector: String, accessToken: String): String {
        // create path and map variables
