...
public class UserVariableApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function user_variables_post (accessToken: String, body: UserVariable): String {
        // create path and map variables
        var path: String = "/userVariables".replace(/{format}/g,"xml");
     ...
     * Returns InlineResponse20030 
     */
    public function user_variables_id_get (id: Number, accessToken: String): String {
        // create path and map variables
     ...
     */
    public function user_variables_id_put (id: Number, accessToken: String, body: UserVariable): String {
        // create path and map variables
        var path: String = "/userVariables/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
     ...
     * Returns InlineResponse2002 
     */
    public function user_variables_id_delete (id: Number, accessToken: String): String {
        // create path and map variables
        var path: String = "/userVariables/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
